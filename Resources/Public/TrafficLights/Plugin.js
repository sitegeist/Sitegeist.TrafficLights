...
var _readFromConsumerApi = __webpack_require__(3);
...
// module
exports.push([module.i, ".reset__reset___3Y_S- {\n    font-family: 'Open Sans', sans-serif;\n    font-weight: normal;\n    color: #FFF;\n    margin: 0;\n    padding: 0;\n}\n\n    .reset__reset___3Y_S-,\n    .reset__reset___3Y_S-:before,\n    .reset__reset___3Y_S-:after {\n        -webkit-box-sizing: border-box;\n                box-sizing: border-box;\n    }\n\n    /* some browsers set a font-size or margin in their user stylesheets */\n\n    .reset__reset___3Y_S- input {\n        font-size: 14px;\n        margin: 0;\n    }\n\n    .reset__reset___3Y_S- textarea {\n        font-size: 14px;\n        margin: 0;\n    }\n\n    .reset__reset___3Y_S- select {\n        font-size: 14px;\n        margin: 0;\n    }\n\n    .reset__reset___3Y_S- button {\n        font-size: 14px;\n        margin: 0;\n    }\n\n    .reset__reset___3Y_S- ul {\n        padding: 0;\n    }\n\n    /* webkit adds some weird spacing otherwise */\n\n    .reset__reset___3Y_S- li {\n        display: block;\n    }\n\n    .reset__reset___3Y_S- input::-webkit-search-cancel-button {\n        display: none;\n    }\n\n    /* webkit adds white box around search box */\n\n    .reset__reset___3Y_S- input {\n        -webkit-appearance: none;\n           -moz-appearance: none;\n                appearance: none;\n    }\n", ""]);

// exports
exports.locals = {
	"reset": "reset__reset___3Y_S-"
};
...
var _reactCssThemr = __webpack_require__(61);

var _identifiers = __webpack_require__(65);
...
var _tree3 = __webpack_require__(71);

var _tree4 = _interopRequireDefault(_tree3);

var _node3 = __webpack_require__(79);

var _node4 = _interopRequireDefault(_node3);

var _injectProps = __webpack_require__(178);

var _injectProps2 = _interopRequireDefault(_injectProps);

var _reactUiComponents = __webpack_require__(179);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ThemedTree = (0, _reactCssThemr.themr)(_identifiers2.default.tree, _tree2.default)(_tree4.default);
var ThemedTreeNode = (0, _reactCssThemr.themr)(_identifiers2.default.treeNode, _node2.default)(_node4.default);
var ThemedTreeNodeHeader = (0, _reactCssThemr.themr)(_identifiers2.default.treeNodeHeader, _node2.default)(_node3.Header);
var ThemedTreeNodeContents = (0, _reactCssThemr.themr)(_identifiers2.default.treeNodeContents, _node2.default)(_node3.Contents);
...
var FinalTreeComponent = (0, _injectProps2.default)({
...
exports.default = FinalTreeComponent;
...
var _dndCore = __webpack_require__(81);
...
var _checkDecoratorArguments = __webpack_require__(18);
...
var _disposables = __webpack_require__(163);
...
var _cloneWithRef = __webpack_require__(171);
...
var _neosUiExtensibility = __webpack_require__(56);

var _neosUiExtensibility2 = _interopRequireDefault(_neosUiExtensibility);

var _TrafficLights = __webpack_require__(60);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Sitegeist.TrafficLights', {}, function (globalRegistry) {
    var containerRegistry = globalRegistry.get('containers');

    containerRegistry.set('LeftSideBar/Top/PageTree', _TrafficLights.PageTree);
});
...
var _createConsumerApi = __webpack_require__(57);
...
var _manifest = __webpack_require__(59);
...
exports.PageTree = exports.default = undefined;
...
var _Tree = __webpack_require__(36);

var _Tree2 = _interopRequireDefault(_Tree);

var _neosUiReduxStore = __webpack_require__(53);
...
var NodeTree = (_temp2 = _class = function (_PureComponent) {
    _inherits(NodeTree, _PureComponent);
    ...
    function NodeTree() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NodeTree.__proto__ || Object.getPrototypeOf(NodeTree)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            currentlyDraggedNode: null
        }, _this.handleToggle = function (contextPath) {
            var toggle = _this.props.toggle;


            toggle(contextPath);
        }, _this.handleFocus = function (contextPath, openInNewWindow) {
            var _this$props = _this.props,
                focus = _this$props.focus,
                allowOpeningNodesInNewWindow = _this$props.allowOpeningNodesInNewWindow;
            ...
            focus(contextPath);
        }, _this.handleClick = function (src, contextPath, openInNewWindow) {
            var _this$props2 = _this.props,
                setActiveContentCanvasSrc = _this$props2.setActiveContentCanvasSrc,
                setActiveContentCanvasContextPath = _this$props2.setActiveContentCanvasContextPath,
                requestScrollIntoView = _this$props2.requestScrollIntoView,
                allowOpeningNodesInNewWindow = _this$props2.allowOpeningNodesInNewWindow,
                reload = _this$props2.reload,
                contentCanvasSrc = _this$props2.contentCanvasSrc;
        ...
        }, _this.handleDrag = function (node) {
            _this.setState({
                currentlyDraggedNode: node
            });
        }, _this.handleDrop = function (targetNode, position) {
            var currentlyDraggedNode = _this.state.currentlyDraggedNode;
            var moveNode = _this.props.moveNode;

            moveNode((0, _plowJs.$get)('contextPath', currentlyDraggedNode), (0, _plowJs.$get)('contextPath', targetNode), position);
    ...
    _createClass(NodeTree, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                ChildRenderer = _props.ChildRenderer;
            ...
            var classNames = (0, _classnames2.default)(_defineProperty({}, _style2.default.pageTree, true));

            return _react2.default.createElement(
                _Tree2.default,
                { className: classNames },
                _react2.default.createElement(ChildRenderer, {
    ...
    ChildRenderer: _propTypes2.default.func,
    rootNode: _propTypes2.default.object,
    allowOpeningNodesInNewWindow: _propTypes2.default.bool,
    nodeTypeRole: _propTypes2.default.string,
    contentCanvasSrc: _propTypes2.default.string,
    reload: _propTypes2.default.func,
    toggle: _propTypes2.default.func,
    focus: _propTypes2.default.func,
    requestScrollIntoView: _propTypes2.default.func,
    setActiveContentCanvasSrc: _propTypes2.default.func,
    setActiveContentCanvasContextPath: _propTypes2.default.func,
    moveNode: _propTypes2.default.func
}, _temp2);
exports.default = NodeTree;
var PageTree = exports.PageTree = (0, _reactRedux.connect)(function (state) {
    return {
        rootNode: _neosUiReduxStore.selectors.CR.Nodes.siteNodeSelector(state),
        ChildRenderer: _index.PageTreeNode,
        allowOpeningNodesInNewWindow: true,
        contentCanvasSrc: (0, _plowJs.$get)('ui.contentCanvas.src', state)
    };
}, {
    toggle: _neosUiReduxStore.actions.UI.PageTree.toggle,
    focus: _neosUiReduxStore.actions.UI.PageTree.focus,
    reload: _neosUiReduxStore.actions.UI.ContentCanvas.reload,
    setActiveContentCanvasSrc: _neosUiReduxStore.actions.UI.ContentCanvas.setSrc,
    setActiveContentCanvasContextPath: _neosUiReduxStore.actions.UI.ContentCanvas.setContextPath,
    moveNode: _neosUiReduxStore.actions.CR.Nodes.move,
...
var _ThemeProvider = __webpack_require__(62);
...
var _themr = __webpack_require__(64);
...
var _themrShape = __webpack_require__(63);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--7-2!../../node_modules/postcss-loader/lib/index.js??ref--7-3!./tree.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--7-2!../../node_modules/postcss-loader/lib/index.js??ref--7-3!./tree.css");
...
// module
exports.push([module.i, ".tree__treeWrapper___2sbnQ {\n\n    padding: 5px 0;\n}\n\n    .tree__treeWrapper___2sbnQ:focus {\n        outline: 0;\n    }\n", ""]);

// exports
exports.locals = {
	"treeWrapper": "tree__treeWrapper___2sbnQ " + __webpack_require__(4).locals["reset"] + ""
};
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--7-2!../../node_modules/postcss-loader/lib/index.js??ref--7-3!./node.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--7-2!../../node_modules/postcss-loader/lib/index.js??ref--7-3!./node.css");
...
// exports
exports.locals = {
	"header": "node__header___IYjFN " + __webpack_require__(4).locals["reset"] + "",
	"header__chevron": "node__header__chevron___16rco " + __webpack_require__(4).locals["reset"] + "",
	"header__chevron--isCollapsed": "node__header__chevron--isCollapsed___1lDfA",
	"header__chevron--isHiddenInIndex": "node__header__chevron--isHiddenInIndex___3HVe5",
	...
	"header__data--isDirty": "node__header__data--isDirty___3pwwI",
	"header__data--isFocused": "node__header__data--isFocused___3zHPu",
	"header__data--acceptsDrop": "node__header__data--acceptsDrop___2yqLu",
	"header__data--deniesDrop": "node__header__data--deniesDrop___2C_Jy",
	"header__labelWrapper": "node__header__labelWrapper___v6nSo",
	"header__label": "node__header__label___P0o2B " + __webpack_require__(4).locals["reset"] + "",
	"header__data--isActive": "node__header__data--isActive___3_Ui0",
	"contents": "node__contents___3c2q8 " + __webpack_require__(4).locals["reset"] + "",
	"dropTarget": "node__dropTarget___13wiP",
	"dropTarget--before": "node__dropTarget--before___1GlQu",
	"dropTarget--after": "node__dropTarget--after___gC7Oc",
	"dropTarget__inner": "node__dropTarget__inner___aiss_",
	"dropTarget__inner--acceptsDrop": "node__dropTarget__inner--acceptsDrop___13kjs"
};
...
var _reactDndScrollzone = __webpack_require__(72);
...
var ScrollingComponent = (0, _reactDndScrollzone2.default)('div');
var verticalStrength = (0, _reactDndScrollzone.createVerticalStrength)(50);

var Tree = exports.Tree = (_temp = _class = function (_PureComponent) {
    ...
    _createClass(Tree, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                theme = _props.theme,
                rest = _objectWithoutProperties(_props, ['NodeComponent', 'className', 'theme']);

            var classNames = (0, _classnames2.default)((_mergeClassNames = {}, _defineProperty(_mergeClassNames, className, className && className.length), _defineProperty(_mergeClassNames, theme.treeWrapper, true), _mergeClassNames));
            ...
            return _react2.default.createElement(
                ScrollingComponent,
                {
                    ...
                    horizontalStrength: (0, _reactDndScrollzone.createHorizontalStrength)(50),
                    className: classNames,
                    tabIndex: '0',
                    role: 'tree'
                },
    ...
    onNodeFocus: _propTypes2.default.func,

    children: _propTypes2.default.any.isRequired,
    theme: _propTypes2.default.shape({ /* eslint-disable quote-props */
        'treeWrapper': _propTypes2.default.string
    }).isRequired, /* eslint-enable quote-props */

    //
    // Static component dependencies which are injected from the outside (index.js)
    //
    NodeComponent: _propTypes2.default.any.isRequired
}, _temp);
...
var _reactDisplayName = __webpack_require__(77);
...
exports.Contents = exports.Header = exports.Node = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _class, _temp, _dec, _class2, _class3, _temp2, _dec2, _dec3, _class4, _class5, _temp3, _class6, _temp4;
...
var _reactDnd = __webpack_require__(80);
...
var spec = {
    canDrop: function canDrop(_ref) {
        var dragAndDropContext = _ref.dragAndDropContext,
            mode = _ref.mode;

        return dragAndDropContext.accepts(mode || 'into');
    },
    drop: function drop(_ref2) {
        var dragAndDropContext = _ref2.dragAndDropContext,
            mode = _ref2.mode;
...
var Node = exports.Node = (_temp = _class = function (_PureComponent) {
    ...
    _createClass(Node, [{
        ...
        value: function render() {
            ...
            var rest = (0, _lodash2.default)(restProps, ['theme']);

            return _react2.default.createElement(
                'div',
                _extends({}, rest, { role: 'treeitem' }),
                children
            );
        }
    }]);
...
var NodeDropTarget = (_dec = (0, _reactDnd.DropTarget)(function (_ref3) {
    var nodeDndType = _ref3.nodeDndType;
    return nodeDndType;
}, spec, collect), _dec(_class2 = (_temp2 = _class3 = function (_PureComponent2) {
    _inherits(NodeDropTarget, _PureComponent2);

    function NodeDropTarget() {
        _classCallCheck(this, NodeDropTarget);

        return _possibleConstructorReturn(this, (NodeDropTarget.__proto__ || Object.getPrototypeOf(NodeDropTarget)).apply(this, arguments));
    }

    _createClass(NodeDropTarget, [{
        key: 'render',
        value: function render() {
            var _mergeClassNames, _mergeClassNames2;
            ...
            var classNames = (0, _classnames2.default)((_mergeClassNames = {}, _defineProperty(_mergeClassNames, theme.dropTarget, true), _defineProperty(_mergeClassNames, theme['dropTarget--before'], mode === 'before'), _defineProperty(_mergeClassNames, theme['dropTarget--after'], mode === 'after'), _mergeClassNames));
            var classNamesInner = (0, _classnames2.default)((_mergeClassNames2 = {}, _defineProperty(_mergeClassNames2, theme.dropTarget__inner, true), _defineProperty(_mergeClassNames2, theme['dropTarget__inner--acceptsDrop'], isOver && canDrop), _mergeClassNames2));
            return connectDropTarget(_react2.default.createElement(
                'div',
                { className: classNames },
                _react2.default.createElement('div', { className: classNamesInner })
            ));
        }
    }]);
    ...
    nodeDndType: _propTypes2.default.string.isRequired,
    canDrop: _propTypes2.default.bool.isRequired,
    isOver: _propTypes2.default.bool,
    theme: _propTypes2.default.object,
    mode: _propTypes2.default.string.isRequired
}, _temp2)) || _class2);
var Header = exports.Header = (_dec2 = (0, _reactDnd.DragSource)(function (_ref4) {
    var nodeDndType = _ref4.nodeDndType;
    return nodeDndType;
}, {
    ...
    canDrag: function canDrag(_ref5) {
        var dragForbidden = _ref5.dragForbidden;
...
}), _dec3 = (0, _reactDnd.DropTarget)(function (_ref6) {
    var nodeDndType = _ref6.nodeDndType;
    return nodeDndType;
}, spec, collect), _dec2(_class4 = _dec3(_class4 = (_temp3 = _class5 = function (_PureComponent3) {
    _inherits(Header, _PureComponent3);
    ...
    _createClass(Header, [{
        key: 'render',
        value: function render() {
            var _mergeClassNames3;

            var _props3 = this.props,
                id = _props3.id,
                labelIdentifier = _props3.labelIdentifier,
                nodeDndType = _props3.nodeDndType,
                IconComponent = _props3.IconComponent,
                hasChildren = _props3.hasChildren,
                isLastChild = _props3.isLastChild,
                isActive = _props3.isActive,
                isFocused = _props3.isFocused,
                isHidden = _props3.isHidden,
                isHiddenInIndex = _props3.isHiddenInIndex,
                isDirty = _props3.isDirty,
                isLoading = _props3.isLoading,
                label = _props3.label,
                icon = _props3.icon,
                iconLabel = _props3.iconLabel,
                level = _props3.level,
                onClick = _props3.onClick,
                onLabelClick = _props3.onLabelClick,
                theme = _props3.theme,
                connectDragSource = _props3.connectDragSource,
                connectDropTarget = _props3.connectDropTarget,
                dragAndDropContext = _props3.dragAndDropContext,
                isOver = _props3.isOver,
                isDragging = _props3.isDragging,
                nodeHasForeignChanges = _props3.nodeHasForeignChanges,
                foreignWorkspacesWithChanges = _props3.foreignWorkspacesWithChanges,
                canDrop = _props3.canDrop,
                restProps = _objectWithoutProperties(_props3, ['id', 'labelIdentifier', 'nodeDndType', 'IconComponent', 'hasChildren', 'isLastChild', 'isActive', 'isFocused', 'isHidden', 'isHiddenInIndex', 'isDirty', 'isLoading', 'label', 'icon', 'iconLabel', 'level', 'onClick', 'onLabelClick', 'theme', 'connectDragSource', 'connectDropTarget', 'dragAndDropContext', 'isOver', 'isDragging', 'nodeHasForeignChanges', 'foreignWorkspacesWithChanges', 'canDrop']);
            ...
            var foreignWorkspacesWithChangesMessage = function foreignWorkspacesWithChangesMessage() {
            ...
            return connectDragSource(_react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(NodeDropTarget, {
                        id: id,
                        theme: theme,
                    ...
                    isLastChild && _react2.default.createElement(NodeDropTarget, {
                        id: id,
                        theme: theme,
                        dragAndDropContext: dragAndDropContext,
                        nodeDndType: nodeDndType,
        ...
        value: function renderCollapseControl() {
            ...
            var _props4 = this.props,
                ...
                isCollapsed = _props4.isCollapsed,
                hasError = _props4.hasError,
                isHiddenInIndex = _props4.isHiddenInIndex,
                isHidden = _props4.isHidden,
            ...
            switch (true) {
                case hasError:
                    icon = _react2.default.createElement(IconComponent, { icon: 'ban' });
                    break;
                case isLoading:
                    icon = _react2.default.createElement(IconComponent, { icon: 'spinner', spin: true });
                    break;
                default:
                    icon = _react2.default.createElement(IconComponent, { icon: 'sort-down' });
                    break;
            }

            var marginLeft = (level - 1) * 18 + 5;
            return _react2.default.createElement(
                'a',
                { style: { marginLeft: marginLeft + 'px' }, role: 'button', onClick: onToggle, className: classnames, 'data-neos-integrational-test': 'tree__item__nodeHeader__subTreetoggle' },
                icon
            );
        }
    }]);
    ...
    return Header;
}(_react.PureComponent), _class5.propTypes = {
    id: _propTypes2.default.string,
    labelIdentifier: _propTypes2.default.string,
    nodeDndType: _propTypes2.default.string.isRequired,
    ...
    isDirty: _propTypes2.default.bool,
    nodeHasForeignChanges: _propTypes2.default.bool,
    foreignWorkspacesWithChanges: _propTypes2.default.array,
    isHiddenInIndex: _propTypes2.default.bool,
    hasError: _propTypes2.default.bool.isRequired,
    label: _propTypes2.default.string.isRequired,
    icon: _propTypes2.default.string,
    iconLabel: _propTypes2.default.string,
    level: _propTypes2.default.number.isRequired,
    dragAndDropContext: _propTypes2.default.shape({
        accepts: _propTypes2.default.func.isRequired,
    ...
    isOver: _propTypes2.default.bool,
    dragForbidden: _propTypes2.default.bool,

    onToggle: _propTypes2.default.func,
    onClick: _propTypes2.default.func,
    onLabelClick: _propTypes2.default.func,
    theme: _propTypes2.default.shape({ /* eslint-disable quote-props */
        'header__data': _propTypes2.default.string,
        'header__data--isActive': _propTypes2.default.string,
        'header__data--isFocused': _propTypes2.default.string,
        'header': _propTypes2.default.string,
        'header__labelWrapper': _propTypes2.default.string,
        'header__label': _propTypes2.default.string,
        'header__chevron': _propTypes2.default.string,
        'header__chevron--isCollapsed': _propTypes2.default.string,
        'header__chevron--isLoading': _propTypes2.default.string,
        'header__icon': _propTypes2.default.string,
        'dropZone': _propTypes2.default.string,
        'dropZone--accepts': _propTypes2.default.string,
        'dropZone--denies': _propTypes2.default.string
    }).isRequired, /* eslint-enable quote-props */

    //
    // Static component dependencies which are injected from the outside (index.js)
    //
    IconComponent: _propTypes2.default.any.isRequired
}, _temp3)) || _class4) || _class4);
var Contents = exports.Contents = (_temp4 = _class6 = function (_PureComponent4) {
    _inherits(Contents, _PureComponent4);
    ...
    return Contents;
}(_react.PureComponent), _class6.propTypes = {
    children: _propTypes2.default.node,
    theme: _propTypes2.default.shape({ /* eslint-disable quote-props */
...
var _DragDropContext = __webpack_require__(38);
...
var _DragDropContextProvider = __webpack_require__(160);
...
var _DragLayer = __webpack_require__(161);
...
var _DragDropManager = __webpack_require__(82);
...
var _DragSource = __webpack_require__(157);
...
var _DropTarget = __webpack_require__(158);
...
var _createTestBackend = __webpack_require__(159);
...
var _createStore = __webpack_require__(83);
...
var _DragDropMonitor = __webpack_require__(152);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(5), __webpack_require__(90)(module)))
...
var _dragOperation = __webpack_require__(93);
...
var _dirtyHandlerIds = __webpack_require__(45);

var _dirtyHandlerIds2 = _interopRequireDefault(_dirtyHandlerIds);

var _stateId = __webpack_require__(151);
...
var _without = __webpack_require__(94);
...
var baseDifference = __webpack_require__(41),
    baseFlatten = __webpack_require__(140),
...
var SetCache = __webpack_require__(25),
    ...
    arrayIncludesWith = __webpack_require__(27),
    cacheHas = __webpack_require__(29),
    createSet = __webpack_require__(146),
...
var _HandlerRegistry = __webpack_require__(153);
...
var _asap = __webpack_require__(154);

var _asap2 = _interopRequireDefault(_asap);

var _registry = __webpack_require__(17);

var _getNextUniqueId = __webpack_require__(156);
...
var rawAsap = __webpack_require__(155);
...
var _registerSource = __webpack_require__(167);

var _registerSource2 = _interopRequireDefault(_registerSource);

var _createSourceFactory = __webpack_require__(168);

var _createSourceFactory2 = _interopRequireDefault(_createSourceFactory);

var _createSourceMonitor = __webpack_require__(169);
...
var _registerTarget = __webpack_require__(173);
...
var _createTargetConnector = __webpack_require__(176);
...
exports.default = function (dependencies) {
    return function (WrappedComponent) {
        var ComponentWithDependencies = function ComponentWithDependencies(props) {
            return _react2.default.createElement(WrappedComponent, _extends({}, dependencies, props));
        };
...
exports.ContentTreeNode = exports.PageTreeNode = exports.default = undefined;
...
var _neosUiDecorators = __webpack_require__(184);

var _amator = __webpack_require__(185);

var _amator2 = _interopRequireDefault(_amator);

var _hashSum = __webpack_require__(187);

var _hashSum2 = _interopRequireDefault(_hashSum);

var _he = __webpack_require__(188);

var he = _interopRequireWildcard(_he);
...
var getContextPath = (0, _plowJs.$get)('contextPath');
...
var stripTags = function stripTags(string) {
    return string && string.replace(/<\/?[^>]+(>|$)/g, '');
};

var decodeHtml = he.decode;

//
// Finds the first parent element that has a scrollbar
//
var findScrollingParent = function findScrollingParent(parentElement) {
...
var getOrDefault = function getOrDefault(defaultValue) {
    return function (value) {
        return value || defaultValue;
    };
};

var decodeLabel = (0, _lodash2.default)(decodeHtml, stripTags, getOrDefault(''));

var Node = (_temp2 = _class = function (_PureComponent) {
    _inherits(Node, _PureComponent);
    ...
    function Node() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Node.__proto__ || Object.getPrototypeOf(Node)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        }, _this.accepts = function (mode) {
            var _this$props = _this.props,
                node = _this$props.node,
                currentlyDraggedNode = _this$props.currentlyDraggedNode,
                canBeInsertedAlongside = _this$props.canBeInsertedAlongside,
                canBeInsertedInto = _this$props.canBeInsertedInto;

            var canBeInserted = mode === 'into' ? canBeInsertedInto : canBeInsertedAlongside;

            return canBeInserted && getContextPath(currentlyDraggedNode) !== getContextPath(node);
        }, _this.handleNodeDrag = function () {
            var _this$props2 = _this.props,
                node = _this$props2.node,
                onNodeDrag = _this$props2.onNodeDrag;


            onNodeDrag(node);
        }, _this.handleNodeDrop = function (position) {
            var _this$props3 = _this.props,
                node = _this$props3.node,
                onNodeDrop = _this$props3.onNodeDrop;
            ...
            onNodeToggle((0, _plowJs.$get)('contextPath', node));
        }, _this.handleNodeClick = function (e) {
            var _this$props5 = _this.props,
                node = _this$props5.node,
                onNodeFocus = _this$props5.onNodeFocus,
                onNodeClick = _this$props5.onNodeClick;

            var openInNewWindow = e.metaKey || e.shiftKey || e.ctrlKey;
            onNodeFocus((0, _plowJs.$get)('contextPath', node), openInNewWindow);
            onNodeClick((0, _plowJs.$get)('uri', node), (0, _plowJs.$get)('contextPath', node), openInNewWindow);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Node, [{
        ...
        key: 'scrollFocusedNodeIntoView',
        value: function scrollFocusedNodeIntoView() {
            if (this.state.shouldScrollIntoView && this.domNode) {
                var scrollingElement = findScrollingParent(this.domNode);
                if (scrollingElement) {
                    var nodeTopPosition = this.domNode.getBoundingClientRect().top;
                    var offset = 50;
                    var scrollingElementPosition = scrollingElement.getBoundingClientRect();
                    var nodeIsNotInView = nodeTopPosition < scrollingElementPosition.top + offset || nodeTopPosition > scrollingElementPosition.bottom - offset;
                    if (nodeIsNotInView) {
                        var scrollTop = nodeTopPosition - scrollingElement.firstElementChild.getBoundingClientRect().top - offset;
                        (0, _amator2.default)({ scrollTop: scrollingElement.scrollTop }, { scrollTop: scrollTop }, {
        ...
        value: function getIcon() {
            ...
            return (0, _plowJs.$get)('ui.icon', nodeTypesRegistry.get(nodeType));
        }
    }, {
        key: 'getNodeTypeLabel',
        value: function getNodeTypeLabel() {
            var _props2 = this.props,
                node = _props2.node,
                nodeTypesRegistry = _props2.nodeTypesRegistry,
                i18nRegistry = _props2.i18nRegistry;

            var nodeType = (0, _plowJs.$get)('nodeType', node);
            var nodeTypeLabel = (0, _plowJs.$get)('ui.label', nodeTypesRegistry.get(nodeType));
        ...
        value: function isActive() {
            var _props3 = this.props,
                isActive = _props3.isActive,
                isContentTreeNode = _props3.isContentTreeNode;
        ...
        value: function isCollapsed() {
            var _props4 = this.props,
                node = _props4.node,
                toggledNodeContextPaths = _props4.toggledNodeContextPaths,
                rootNode = _props4.rootNode,
                loadingDepth = _props4.loadingDepth;


            var isToggled = toggledNodeContextPaths.includes((0, _plowJs.$get)('contextPath', node));
        ...
        value: function isHidden() {
            var _props5 = this.props,
                node = _props5.node,
                hiddenContextPaths = _props5.hiddenContextPaths;

            return hiddenContextPaths && hiddenContextPaths.includes((0, _plowJs.$get)('contextPath', node));
        }
    }, {
        key: 'isIntermediate',
        value: function isIntermediate() {
            var _props6 = this.props,
                node = _props6.node,
                intermediateContextPaths = _props6.intermediateContextPaths;

            return intermediateContextPaths && intermediateContextPaths.includes((0, _plowJs.$get)('contextPath', node));
        }
    }, {
        key: 'isLoading',
        value: function isLoading() {
            var _props7 = this.props,
                node = _props7.node,
                loadingNodeContextPaths = _props7.loadingNodeContextPaths;


            return loadingNodeContextPaths ? loadingNodeContextPaths.includes((0, _plowJs.$get)('contextPath', node)) : false;
        }
    }, {
        key: 'hasError',
        value: function hasError() {
            var _props8 = this.props,
                node = _props8.node,
                errorNodeContextPaths = _props8.errorNodeContextPaths;


            return errorNodeContextPaths ? errorNodeContextPaths.includes((0, _plowJs.$get)('contextPath', node)) : false;
        }
    }, {
        key: 'getDragAndDropContext',
        value: function getDragAndDropContext() {
            return {
        ...
        value: function render() {
            ...
            var _props9 = this.props,
                ChildRenderer = _props9.ChildRenderer,
                node = _props9.node,
                nodeDndType = _props9.nodeDndType,
                nodeTypeRole = _props9.nodeTypeRole,
                childNodes = _props9.childNodes,
                hasChildren = _props9.hasChildren,
                isLastChild = _props9.isLastChild,
                level = _props9.level,
                onNodeToggle = _props9.onNodeToggle,
                onNodeClick = _props9.onNodeClick,
                onNodeFocus = _props9.onNodeFocus,
                onNodeDrag = _props9.onNodeDrag,
                onNodeDrop = _props9.onNodeDrop,
                currentlyDraggedNode = _props9.currentlyDraggedNode,
                isContentTreeNode = _props9.isContentTreeNode,
            ...
            var refHandler = function refHandler(div) {
                _this2.domNode = div;
            };
            var childNodesCount = childNodes.count();

            var labelIdentifier = (isContentTreeNode ? 'content-' : '') + 'treeitem-' + (0, _hashSum2.default)((0, _plowJs.$get)('contextPath', node)) + '-label';

            return _react2.default.createElement(
                _Tree2.default.Node,
                { 'aria-expanded': this.isCollapsed() ? 'false' : 'true', 'aria-labelledby': labelIdentifier },
                _react2.default.createElement('span', { ref: refHandler }),
                _react2.default.createElement(_Tree2.default.Node.Header, {
                    labelIdentifier: labelIdentifier,
                    id: (0, _plowJs.$get)('contextPath', node),
                    ...
                    isHidden: (0, _plowJs.$get)('properties._hidden', node),
                    isHiddenInIndex: (0, _plowJs.$get)('properties._hiddenInIndex', node) || this.isIntermediate(),
                    hasError: this.hasError(),
                    label: decodeLabel((0, _plowJs.$get)('label', node)),
                    icon: this.getIcon(),
                    ...
                    dragForbidden: (0, _plowJs.$get)('isAutoCreated', node)
                }),
                this.isCollapsed() ? null : _react2.default.createElement(
                    _Tree2.default.Node.Contents,
                    null,
                    childNodes.filter(function (n) {
                        return n;
                    }).map(function (node, index) {
                        return _react2.default.createElement(ChildRenderer, {
                            ChildRenderer: ChildRenderer,
                            key: (0, _plowJs.$get)('contextPath', node),
                            node: node,
                            nodeDndType: nodeDndType,
    ...
    isContentTreeNode: _propTypes2.default.bool,
    rootNode: _propTypes2.default.object,
    loadingDepth: _propTypes2.default.number,
    ChildRenderer: _propTypes2.default.func.isRequired,
    node: _propTypes2.default.object,
    nodeDndType: _propTypes2.default.string.isRequired,
    nodeTypeRole: _propTypes2.default.string,
    currentlyDraggedNode: _propTypes2.default.object,
    hasChildren: _propTypes2.default.bool,
    isLastChild: _propTypes2.default.bool,
    childNodes: _propTypes2.default.object,
    level: _propTypes2.default.number.isRequired,
    isActive: _propTypes2.default.bool,
    isFocused: _propTypes2.default.bool,
    toggledNodeContextPaths: _propTypes2.default.object,
    hiddenContextPaths: _propTypes2.default.object,
    intermediateContextPaths: _propTypes2.default.object,
    loadingNodeContextPaths: _propTypes2.default.object,
    errorNodeContextPaths: _propTypes2.default.object,
    canBeInsertedAlongside: _propTypes2.default.bool,
    canBeInsertedInto: _propTypes2.default.bool,
    isNodeDirty: _propTypes2.default.bool.isRequired,
    nodeHasForeignChanges: _propTypes2.default.bool,
    foreignWorkspacesWithChanges: _propTypes2.default.array,
    ...
    getTreeNode: _propTypes2.default.func,
    onNodeToggle: _propTypes2.default.func,
    onNodeClick: _propTypes2.default.func,
    onNodeFocus: _propTypes2.default.func,
    onNodeDrag: _propTypes2.default.func,
    onNodeDrop: _propTypes2.default.func
}, _temp2);
exports.default = Node;


var withNodeTypeRegistryAndI18nRegistry = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
...
var PageTreeNode = exports.PageTreeNode = withNodeTypeRegistryAndI18nRegistry((0, _reactRedux.connect)(function (state, _ref3) {
    var neos = _ref3.neos,
        nodeTypesRegistry = _ref3.nodeTypesRegistry;

    var allowedNodeTypes = nodeTypesRegistry.getSubTypesOf(nodeTypesRegistry.getRole('document'));

    var childrenOfSelector = _neosUiReduxStore.selectors.CR.Nodes.makeChildrenOfSelector(allowedNodeTypes);
    var hasChildrenSelector = _neosUiReduxStore.selectors.CR.Nodes.makeHasChildrenSelector(allowedNodeTypes);
    var canBeMovedAlongsideSelector = _neosUiReduxStore.selectors.CR.Nodes.makeCanBeMovedAlongsideSelector(nodeTypesRegistry);
    var canBeMovedIntoSelector = _neosUiReduxStore.selectors.CR.Nodes.makeCanBeMovedIntoSelector(nodeTypesRegistry);
    var isDocumentNodeDirtySelector = _neosUiReduxStore.selectors.CR.Workspaces.makeIsDocumentNodeDirtySelector();
    var nodeHasForeignChangesSelector = (0, _selectors.makeNodeHasForeignChangesSelector)();
    var foreignWorkspacesWithChangesSelector = (0, _selectors.makeForeignWorkspacesWithChangesSelector)();

    return function (state, _ref4) {
        var node = _ref4.node,
            currentlyDraggedNode = _ref4.currentlyDraggedNode;
        return {
            ...
            isActive: _neosUiReduxStore.selectors.UI.ContentCanvas.getCurrentContentCanvasContextPath(state) === (0, _plowJs.$get)('contextPath', node),
            isFocused: _neosUiReduxStore.selectors.UI.PageTree.getFocused(state) === (0, _plowJs.$get)('contextPath', node),
            toggledNodeContextPaths: _neosUiReduxStore.selectors.UI.PageTree.getToggled(state),
            hiddenContextPaths: _neosUiReduxStore.selectors.UI.PageTree.getHidden(state),
            intermediateContextPaths: _neosUiReduxStore.selectors.UI.PageTree.getIntermediate(state),
            loadingNodeContextPaths: _neosUiReduxStore.selectors.UI.PageTree.getLoading(state),
            errorNodeContextPaths: _neosUiReduxStore.selectors.UI.PageTree.getErrors(state),
            isNodeDirty: isDocumentNodeDirtySelector(state, (0, _plowJs.$get)('contextPath', node)),
            nodeHasForeignChanges: nodeHasForeignChangesSelector(state, (0, _plowJs.$get)('contextPath', node)),
            foreignWorkspacesWithChanges: foreignWorkspacesWithChangesSelector(state, (0, _plowJs.$get)('contextPath', node)),
...
var ContentTreeNode = exports.ContentTreeNode = withNodeTypeRegistryAndI18nRegistry((0, _reactRedux.connect)(function (state, _ref5) {
    var neos = _ref5.neos,
        nodeTypesRegistry = _ref5.nodeTypesRegistry;

    var allowedNodeTypes = [].concat(nodeTypesRegistry.getSubTypesOf(nodeTypesRegistry.getRole('content')), nodeTypesRegistry.getSubTypesOf(nodeTypesRegistry.getRole('contentCollection')));

    var childrenOfSelector = _neosUiReduxStore.selectors.CR.Nodes.makeChildrenOfSelector(allowedNodeTypes);
    var hasChildrenSelector = _neosUiReduxStore.selectors.CR.Nodes.makeHasChildrenSelector(allowedNodeTypes);
    var canBeMovedAlongsideSelector = _neosUiReduxStore.selectors.CR.Nodes.makeCanBeMovedAlongsideSelector(nodeTypesRegistry);
    var canBeMovedIntoSelector = _neosUiReduxStore.selectors.CR.Nodes.makeCanBeMovedIntoSelector(nodeTypesRegistry);
    var isContentNodeDirtySelector = _neosUiReduxStore.selectors.CR.Workspaces.makeIsContentNodeDirtySelector();

    return function (state, _ref6) {
        var node = _ref6.node,
            currentlyDraggedNode = _ref6.currentlyDraggedNode;
        return {
            isContentTreeNode: true,
            rootNode: _neosUiReduxStore.selectors.UI.ContentCanvas.documentNodeSelector(state),
            loadingDepth: neos.configuration.structureTree.loadingDepth,
            childNodes: childrenOfSelector(state, getContextPath(node)),
            hasChildren: hasChildrenSelector(state, getContextPath(node)),
            isActive: _neosUiReduxStore.selectors.UI.ContentCanvas.getCurrentContentCanvasContextPath(state) === (0, _plowJs.$get)('contextPath', node),
            isFocused: (0, _plowJs.$get)('cr.nodes.focused.contextPath', state) === (0, _plowJs.$get)('contextPath', node),
            toggledNodeContextPaths: _neosUiReduxStore.selectors.UI.ContentTree.getToggled(state),
            isNodeDirty: isContentNodeDirtySelector(state, (0, _plowJs.$get)('contextPath', node)),
            canBeInsertedAlongside: canBeMovedAlongsideSelector(state, {
                subject: getContextPath(currentlyDraggedNode),
                reference: getContextPath(node)
            }),
...
exports.makeForeignWorkspacesWithChangesSelector = exports.makeNodeHasForeignChangesSelector = undefined;

var _reselect = __webpack_require__(183);
...
var makeNodeHasForeignChangesSelector = exports.makeNodeHasForeignChangesSelector = function makeNodeHasForeignChangesSelector() {
    return (0, _reselect.createSelector)([(0, _plowJs.$get)('cr.nodes.byContextPath'), function (state, contextPath) {
        ...
        return nodes && nodes.filter(function (i) {
            return (0, _plowJs.$get)('hasForeignChanges', i) && (0, _plowJs.$get)('contextPath', i) === contextPath;
        }).count() > 0;
    });
};

var makeForeignWorkspacesWithChangesSelector = exports.makeForeignWorkspacesWithChangesSelector = function makeForeignWorkspacesWithChangesSelector() {
    return (0, _reselect.createSelector)([(0, _plowJs.$get)('cr.nodes.byContextPath'), function (state, contextPath) {
        return contextPath;
    }], function (nodes, contextPath) {
        if (nodes) {
...
var BezierEasing = __webpack_require__(186)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(189)(module), __webpack_require__(5)))
